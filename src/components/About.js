...
import japan_street_pic from "../japan-street.jpg";
...
export default function About() {
    ...
    return (
        <main className="relative">
            <img src={japan_street_pic} alt="Japan Street" className="absolute w-full" />
                ...
                <section className="bg-gray-600 rounded-lg shadow-2xl lg:flex p-20">
                    ...
                    <div className="text-lg flex flex-col justify-center">
                        ...
                        <div className="prose lg:prose-xl text-white">
                            <BlockContent blocks={author.bio} projectId="qzsl1org" dataset="production" />
                        </div>
                    </div>
                </section>
            </div>
